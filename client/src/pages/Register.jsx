...
function Register() {
  ...
  // Creates the account, then sends the user to sign in with their new credentials
  ...
  return (
    <div className="min-h-screen flex items-center">
      ...
      {/* Left half: the actual sign-up form */}
      <div className="flex flex-col items-center justify-center bg-white border border-gray-200 rounded-xl p-8 w-1/2 h-screen">
        ...
        <p className="text-sm text-gray-500 mb-6">Start building your first workflow</p>
        ...
        <p className="text-xs text-gray-500 text-center mt-5">
          Already have an account? <a href="/" className="text-gray-800 underline">Sign in</a>
        </p>
      </div>
      ...
      <div className="flex flex-col items-center w-1/2 h-screen bg-light-cyan-900 text-white
        ...
        <div className="flex flex-col flex-1 justify-center items-center w-2/3">
          <h1 className="text-2xl font-semibold leading-tight">Start with an idea</h1>
          <p>Drop in a prompt, connect it to a model, and watch it run. No setup beyond your first workflow — build as you go</p>
        </div>
